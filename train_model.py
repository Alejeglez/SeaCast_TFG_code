...
def main():
    ...
    parser.add_argument(
        "--seed", type=int, default=None, help="random seed (default: 42)"
    )
    parser.add_argument(
        "--n_nodes",
        type=int,
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="Noise to add to data during evaluation (default: None)",
    )
    ...
    init_train, target_train, forcing_train = train_data_loader[0]
    print(
        f"Train data shape: init {init_train.shape}, "
        f"target {target_train.shape}, forcing {forcing_train.shape}"
    )
